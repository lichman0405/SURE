...
```text
sure-0.0.0-bootstrap-x86_64-pc-windows-msvc.zip
sure-0.0.0-bootstrap-x86_64-pc-windows-msvc.zip.sha256
```

The name is `sure-<version>-x86_64-pc-windows-msvc.zip`, where `<version>` is
what `sure version` prints — `0.0.0-bootstrap` in this build.
