...
Progress: 83 / 166 tasks accepted. **Phase P0 complete (9/9), phase P1 complete
...
accepted as commit `0c6a43a`. `P5-T005` received two follow-up security fixes in
...
`3f9d002`. Phase P8 is open at 6 of 11.
...
**Phase P7 is complete (9/9). Phase P8 is open at 6 of 11.** The READY list is now
`P8-T007`, `P8-T009`, `P8-T011`, `P9-T001`, `P10-T001`, `P11-T001`, `P12-T001`,
`P12-T008`, `P13-T001`, `P13-T004`, `P14-T001`, `P14-T002`, `P14-T003`,
`P14-T005`, `P14-T006`, `P14-T007` and `P14-T010`. The lowest-numbered READY task
is `P8-T007`, *"Implement deterministic claim checkers"*, which is the next
concrete action.
